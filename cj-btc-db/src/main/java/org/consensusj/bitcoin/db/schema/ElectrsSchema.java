...
/**
 * Schema definitions for electrs RocksDB database.
 * Based on: https://github.com/romanz/electrs/blob/master/doc/schema.md
 *
 * This class defines the column families and key formats used by electrs
 * to store Bitcoin blockchain data efficiently in RocksDB.
 *
 * Most data is stored in key-only rows (empty values) to optimize space.
 */
public class ElectrsSchema {

    /**
     * Column family names used by electrs
     */
    public static final class ColumnFamilies {
        ...
        /** Block headers - maps height to header data */
     ...
     * Electrs uses 8-byte prefixes for both script hashes and transaction IDs
     */
    ...
    /**
     * Creates a block header key from height
     * @param height Block height
     * @return 4-byte height in big-endian format
     */
    ...
    /**
     * Decodes block height from a header key
