...
/**
 * Read-only interface to an electrs RocksDB database.
 *
 * This interface provides access to Bitcoin blockchain data stored in the electrs format.
 * It supports querying by script hash (for address history), transaction ID, and block height.
 *
 * The database schema is defined by electrs and documented at:
 * https://github.com/romanz/electrs/blob/master/doc/schema.md
 *
 * @see org.consensusj.bitcoin.db.schema.ElectrsSchema
 */
public interface ElectrsDatabase extends Closeable {
